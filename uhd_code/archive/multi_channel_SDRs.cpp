...
int UHD_SAFE_MAIN(int argc, char *argv[]) {
    ...
    size_t spb;
    double rate, freq1, freq2, gain, power, wave_freq, bw, lo_offset;
    float ampl;
    std::vector<unsigned long> channel; channel.push_back(0); channel.push_back(1);
    ...
    std::vector<double> freqs;  freqs.push_back(freq1); freqs.push_back(freq2);
